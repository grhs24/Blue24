...
1. **Product & prices**: Stripe Dashboard → Product catalog → add ONE product
   ...
   yearly ($14.99). Add a free trial if you want one. Keep both on the same
...
each beta code works whether the user picks the $1.99/mo or the $14.99/yr plan —
a beta user who chooses yearly still gets their 50% off. Pick the coupon
**duration** deliberately: `once` gives 50% off the first invoice (about $7.50 off
...
($1.99) and a yearly ($14.99) variant, and leave the discount applicable to the
